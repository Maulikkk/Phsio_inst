...
class createConference extends StatefulWidget {
  @override
  State<createConference> createState() => PhysioRegFormState();
}

class PhysioRegFormState extends State<createConference> {
                ...
                child: Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Included Certificate, Breakfast, Lunch",
                        style: queStyle,
                      ),
                      SizedBox(
                        width: MediaQuery.of(context).size.width,
                      ...
                      BottomButton(title: 'Create Conference'),
                      SizedBox(
                        height: 20,
                      ),
                    ],
